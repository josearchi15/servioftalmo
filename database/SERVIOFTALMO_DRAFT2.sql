-- Create Database SERVIOFTALMO_DRAFT2
CREATE DATABASE SERVIOFTALMO_DRAFT2;
GO

-- Use the Database
USE SERVIOFTALMO_DRAFT2;
GO
...
-- Add foreign key constraints to CONSULTA table
ALTER TABLE CONSULTA
ADD FOREIGN KEY (Dato_receta_medica) REFERENCES RECETA_MEDICA(Dato_receta_medica);
GO

ALTER TABLE CONSULTA
ADD FOREIGN KEY (Dato_receta_anteojos) REFERENCES RECETA_ANTEOJOS(Dato_receta_anteojos);
GO
