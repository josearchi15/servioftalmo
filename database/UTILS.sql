...
SELECT * FROM SERVIOFTALMO_DRAFT4..PACIENTE (NOLOCK) WHERE Estado = 1

INSERT INTO PACIENTE (Nombres, Apellidos,DPI, No_Registro, Celular, Email)
VALUES ('Paciente2','Prueba2','2714141410101','A00001','51234567','prueba2@gmail.com')

INSERT INTO PACIENTE (Nombres, Apellidos,DPI)
VALUES ('Paciente2','Prueba2','271414141010188') --ejemplo error de length en DPI (13) 
